(function () {
  ...
  (self["webpackChunkng_sortgrid"] = self["webpackChunkng_sortgrid"] || []).push([["default-projects_ng-sortgrid-demo_src_app_shared_shared_module_ts-projects_ng-sortgrid_src_li-9ef736"], {
    ...
    1018: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _sort_sort_ngsg_sort_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./sort/sort/ngsg-sort.service */
      4891);
      /* harmony import */


      var _mutliselect_ngsg_selection_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./mutliselect/ngsg-selection.service */
      1683);
      /* harmony import */


      var _sort_reflection_ngsg_reflect_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      var _shared_ngsg_events_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./shared/ngsg-events.service */
      1602);
      /* harmony import */


      var _helpers_scroll_scroll_helper_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      ...
      var _NgsgItemDirective = /*#__PURE__*/function () {
        function _NgsgItemDirective(el, sortService, selectionService, reflectService, ngsgStore, ngsgEventService, scrollHelperService) {
        ...
        _createClass(_NgsgItemDirective, [{
          ...
          value: function ngOnInit() {
            ...
            this.ngsgEventService.dropped$.pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.takeUntil)(this.destroy$)).subscribe(function () {
              return _this12.selected = false;
            });
            (0, rxjs__WEBPACK_IMPORTED_MODULE_10__.fromEvent)(this.el.nativeElement, 'drag').pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.throttleTime)(20), (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.takeUntil)(this.destroy$), (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.takeWhile)(function () {
    ...
    3275: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      _NgsgModule.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
        type: _NgsgModule
      });
      _NgsgModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({});

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](_NgsgModule, {
          declarations: [_ngsg_item_directive__WEBPACK_IMPORTED_MODULE_0__.NgsgItemDirective],
          exports: [_ngsg_item_directive__WEBPACK_IMPORTED_MODULE_0__.NgsgItemDirective]
        });
      })();
      /***/
        ...
        _createClass(_NgsgSortService, [{
          ...
          value: function sort(dropElement) {
            ...
            this.dragElements.forEach(function (dragElement) {
              ...
              _this13.classService.addPlaceHolderClass(insertedNode);
            });
          ...
          value: function endSort() {
            ...
            this.dragElements.forEach(function (dragElement) {
              _this14.updateDropedItem(dragElement.node);
            });
          }
        }, {
          key: "getSibling",
          ...
          value: function updateDropedItem(item) {
            ...
            (0, rxjs__WEBPACK_IMPORTED_MODULE_3__.timer)(500).subscribe(function () {
              return _this15.classService.removeDroppedClass(item);
            });
          }
        }]);
